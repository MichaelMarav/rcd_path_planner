...
int main()
{
  ...
  std::cout << "Robot Total Nodes -->  " << boost::num_vertices(RobotCaster.G.G) << '\n';
  std::cout << "Robot Total Edges -->  " << boost::num_edges(RobotCaster.G.G) << '\n';

  std::cout << "Target Total Nodes -->  " << boost::num_vertices(TargetCaster.G.G) << '\n';
  std::cout << "Target Total Nodes -->  " << boost::num_edges(TargetCaster.G.G) << '\n';
  ...
  // if (RCD::Core::pathFoundByRobot){
  //   robot_path = RobotCaster.ShortestPath(RCD::Core::intersectionNode);
  //   std::cout << " Path size --> " << robot_path.size() << '\n';
  ...
  // for (const auto& point : robot_path) {
  //   std::cout << "Robot -> " << point.x << "  " << point.y << '\n';
  // }
  // for (const auto& point : target_path) {
